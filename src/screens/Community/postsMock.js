...
export const posts = [
  {
    id: 1,
    type: 'text',
    author: { name: 'Ricardo Almeida', rank: 1, avatar: '/images/user-1.jpg' },
    timeAgo: '2h',
...
Nos próximos treinos vou postar a rotina completa aqui pra galera copiar.`,
  ...
  },
  {
    id: 3,
    type: 'media',
    author: { name: 'Pedro Rocha', rank: 4, avatar: '/images/user-4.jpg' },
    timeAgo: '6h',
  ...
  },
  {
    id: 10,
    type: 'media',
    author: { name: 'Guilherme Ramos', rank: 11, avatar: '/images/user-4.jpg' },
    timeAgo: '22h',
